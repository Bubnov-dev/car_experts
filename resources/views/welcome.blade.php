...
<head>
    ...
    <script type="module" crossorigin src="/assets/index.a26876a1.js"></script>
    <link rel="stylesheet" href="/assets/index.c1b97d4b.css">
</head>
<body>
<header class="header">
        ...
        <div class="flex">
            <div class="components__item item">
                <div class="item__image">
                    <img src="/assets/vin.bb29fd95.png" alt="vin" data-fancybox="demo" data-caption="Технические компоненты">
                </div>
                <div class="item__text h2">VIN</div>
            </div>
            <div class="components__item item">
                <div class="item__image">
                    <img src="/assets/slide1.6764c463.png" alt="vin" data-fancybox="demo" data-caption="Технические компоненты">
                </div>
                <div class="item__text h2">VIN</div>
            </div>
        </div>
...
<section class="components">
    <div class="container">
        ...
        <div class="flex ">
            ...
            <div class="components__item item">
                <img class="item__image" src="/assets/vin.bb29fd95.png" alt="vin">
                <div class="item__desc">
                    Не следует, однако, забывать, что семантический разбор внешних противодействий позволяет
                    выполнить важные задания по разработке направлений. Нет сомнений, что тщательные исследования
                    конкурентов представляют собой, как квинтэссенцию победы маркетинга над разумом и должны быть
...
<footer class="footer">
    ...
    <div class="container footer__container flex">
        ...
        <a href="/pdf" class="btn footer__btn">
            Скачать PDF-версию
        </a>
    </div>
</footer>
